-- This is a copy of the main mappings.lua with a few added commands
-- n, v, i, t = mode names
...
M.general = {
    ...
    n = {
        ...
        -- CUSTOM
        ["<leader>q"] = {":q! <CR>", "   toggle line number"},
...
M.tabufline = {
    ...
    n = {
        ...
        ["<leader>x"] = {
            function() require("core.utils").close_buffer() end,
            "   close buffer"
        }
    }
}
...
M.telescope = {
    n = {
        ...
        -- git
        ["<leader>cm"] = {
            "<cmd> Telescope git_commits <CR>", "   git commits"
        },
        ["<leader>gt"] = {"<cmd> Telescope git_status <CR>", "  git status"},

        -- pick a hidden term
        ["<leader>pt"] = {
            "<cmd> Telescope terms <CR>", "   pick hidden term"
        },
